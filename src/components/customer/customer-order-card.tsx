    ...
    <article className="rounded-[1.5rem] border border-sky-100/80 bg-white p-5 shadow-soft">
      ...
      <div className="mt-4 flex items-end justify-between gap-4 border-t border-sky-100 pt-4">
        ...
        <Link
          ...
          className="inline-flex min-h-11 items-center rounded-full border border-sky-200 px-4 text-sm font-extrabold text-[#083F66] transition hover:bg-sky-50 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--ps-cyan)]"
        >
          Ver pedido
        </Link>
      </div>
