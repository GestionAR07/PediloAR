...
export function CustomerOrderCard({
  ...
  return (
    <article className="rounded-[1.5rem] border border-violet-100/80 bg-white p-5 shadow-soft">
      ...
      <div className="mt-4 flex items-end justify-between gap-4 border-t border-violet-100 pt-4">
        ...
        <Link
          ...
          className="inline-flex min-h-11 items-center rounded-full border border-violet-200 px-4 text-sm font-extrabold text-violet-800 transition hover:bg-violet-50 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--ps-violet)]"
        >
          Ver pedido
        </Link>
      </div>
